...
public class datos_Persona extends javax.swing.JFrame {
    ...
    public datos_Persona() {
        ...
        // Agregar KeyListener para permitir solo letras en el campo de nombres
        txtNombres.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                char c = evt.getKeyChar();
                if (!Character.isLetter(c) && c != ' ' && c != '\b') {
                    evt.consume(); // Ignorar la entrada no válida
                    javax.swing.JOptionPane.showMessageDialog(null, "Solo se permiten letras en el campo Nombres.");
                }
            }
        });

        // Agregar KeyListener para permitir solo números en el campo de teléfono
        txtTelefono.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                char c = evt.getKeyChar();
                if (!Character.isDigit(c)) {
                    evt.consume(); // Ignorar la entrada no válida
                    javax.swing.JOptionPane.showMessageDialog(null, "Solo se permiten números en el campo Teléfono.");
                }
            }
        });
    }
    ...
    private void initComponents() {
        ...
        tblDatos.getAccessibleContext().setAccessibleDescription("");
