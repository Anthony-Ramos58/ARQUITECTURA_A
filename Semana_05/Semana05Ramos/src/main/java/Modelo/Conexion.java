...
public class Conexion {
    ...
    public Connection conectar() {
        ...
        String url = "jdbc:sqlserver://172.20.10.2:1433;databaseName=BaseDeDatosRamos;user=tuUsuario;password=tuContraseña;encrypt=false;trustServerCertificate=true;loginTimeout=30";
